...
Entry spend(String id, double amount, String category, DateTime date,
...
void main() {
  ...
  group('spentByCategory', () {
    test('folds expenses and bills per category, ignores income and other months',
        () {
      final entries = [
        spend('a', 10, 'dining', DateTime(2026, 7, 1)),
        spend('b', 15, 'dining', DateTime(2026, 7, 8)),
        spend('c', 100, 'housing', DateTime(2026, 7, 1), type: EntryType.bill),
        spend('d', 999, 'dining', DateTime(2026, 6, 1)), // other month
        spend('e', 500, 'salary', DateTime(2026, 7, 25), type: EntryType.income),
      ];
  ...
  group('budgetStatuses', () {
    test('joins budgets with spending, most-stressed first', () {
      ...
      final statuses =
          budgetStatuses(entries, {'dining': 100, 'transport': 100}, july);
  ...
  group('suggestedBudgets', () {
    test('evolves 3-month averages into padded, rounded suggestions', () {
      final entries = [
        ...
        spend('d', 999, 'dining', DateTime(2026, 7, 5)), // current month ignored
      ];
    ...
    test('categories missing in some months average over zeros', () {
      final entries = [
        spend('a', 300, 'fun', DateTime(2026, 6, 5)),
      ];
      final suggested = suggestedBudgets(entries, july);
