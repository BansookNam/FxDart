...
Future<void> _openTutorial(String fn) =>
    launchUrl(Uri.parse('$_tutorialBase$fn.html'), webOnlyWindowName: '_blank');
  ...
  Widget build(BuildContext context) {
    ...
    for (final m in _identifier.allMatches(widget.text)) {
      ...
      if (_linkableFns.contains(word)) {
        ...
        spans.add(TextSpan(text: word, style: link, recognizer: recognizer));
      } else {
