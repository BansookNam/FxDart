...
| 2 | running-balance | 100 | 19 µs | 23 µs | **tie** | 16.5 MB | 16.5 MB | tie | 3 |
...
| 10 | sequential-configs (async) | 100 | 416 µs | 435 µs | **tie** | 16.4 MB | 16.9 MB | tie | 3 |
...
| 16 | compound-interest | 100 | 20 µs | 21 µs | **tie** | 16.5 MB | 16.5 MB | tie | 3 |
...
| 20 | bounded-concurrency (async) | 100 | 323 µs | 460 µs | **tie** | 16.5 MB | 17.0 MB | tie | 3 |
...
| 28 | no-spend-streak | 100 | 4.4 µs | 5.2 µs | **tie** | 16.4 MB | 16.4 MB | tie | 3 |
| 29 | duplicate-transactions | 100 | 41 µs | 41 µs | **tie** | 16.5 MB | 16.4 MB | tie | 3 |
| 30 | concurrent-enrichment (async) | 100 | 176 µs | 265 µs | **tie** | 16.5 MB | 17.1 MB | tie | 3 |
...
| 37 | restock-plan | 100 | 11 µs | 9.0 µs | **tie** | 16.5 MB | 16.6 MB | tie | 3 |
...
| 41 | concurrent-profile-fetch (async) | 100 | 285 µs | 391 µs | **tie** | 16.4 MB | 16.6 MB | tie | 3 |
| 42 | flaky-api-retry (async) | 100 | 524 µs | 1.21 ms | **native** | 16.5 MB | 17.0 MB | tie | 3 |
| 43 | price-lookup-fallback (async) | 100 | 376 µs | 583 µs | **tie** | 16.5 MB | 17.2 MB | tie | 3 |
| 44 | stream-windowed-alerts (async) | 100 | 32 µs | 104 µs | **tie** | 16.5 MB | 17.2 MB | tie | 3 |
| 45 | rate-limited-import (async) | 100 | 156 µs | 282 µs | **tie** | 16.5 MB | 17.3 MB | tie | 3 |
| 46 | parallel-downloads (async) | 100 | 361 µs | 488 µs | **tie** | 16.5 MB | 17.3 MB | tie | 3 |
| 47 | paged-feeds-dedupe (async) | 100 | 92 µs | 193 µs | **tie** | 16.5 MB | 17.1 MB | tie | 3 |
| 48 | settlement-pipeline (async) | 100 | 33 µs | 48 µs | **tie** | 16.6 MB | 17.2 MB | tie | 3 |
| 49 | live-search (async) | 100 | 50 µs | 88 µs | **tie** | 16.4 MB | 17.1 MB | tie | 3 |
| 50 | daily-ledger-close (async) | 100 | 408 µs | 455 µs | **tie** | 16.7 MB | 17.1 MB | tie | 3 |
| 51 | category-rank | 100 | 3.7 µs | 9.2 µs | **tie** | 16.5 MB | 16.6 MB | tie | 3 |
| 52 | stock-revaluation (async) | 100 | 351 µs | 557 µs | **tie** | 16.6 MB | 17.3 MB | tie | 3 |
...
| 2 | running-balance | 10000 | 1.95 ms | 2.17 ms | **tie** | 24.0 MB | 23.6 MB | tie | 3 |
...
| 10 | sequential-configs (async) | 10000 | 38.7 ms | 38.5 ms | **tie** | 50.6 MB | 51.6 MB | tie | 3 |
...
| 16 | compound-interest | 10000 | 1.86 ms | 2.12 ms | **tie** | 22.8 MB | 22.8 MB | tie | 3 |
...
| 20 | bounded-concurrency (async) | 10000 | 31.0 ms | 39.1 ms | **native** | 26.2 MB | 22.3 MB | fxdart | 3 |
...
| 28 | no-spend-streak | 10000 | 266 µs | 254 µs | **tie** | 19.6 MB | 19.7 MB | tie | 3 |
| 29 | duplicate-transactions | 10000 | 4.12 ms | 4.20 ms | **tie** | 40.3 MB | 35.9 MB | fxdart | 3 |
| 30 | concurrent-enrichment (async) | 10000 | 18.4 ms | 24.1 ms | **native** | 49.3 MB | 52.3 MB | native | 3 |
...
| 37 | restock-plan | 10000 | 1.27 ms | 1.24 ms | **tie** | 17.5 MB | 22.0 MB | native | 3 |
...
| 41 | concurrent-profile-fetch (async) | 10000 | 29.8 ms | 36.1 ms | **native** | 51.7 MB | 32.1 MB | fxdart | 3 |
| 42 | flaky-api-retry (async) | 10000 | 50.0 ms | 112.3 ms | **native** | 29.4 MB | 24.6 MB | fxdart | 3 |
| 43 | price-lookup-fallback (async) | 10000 | 35.6 ms | 53.3 ms | **native** | 49.1 MB | 38.5 MB | fxdart | 3 |
| 44 | stream-windowed-alerts (async) | 10000 | 3.17 ms | 10.3 ms | **native** | 24.0 MB | 27.9 MB | native | 3 |
| 45 | rate-limited-import (async) | 10000 | 13.4 ms | 27.2 ms | **native** | 23.7 MB | 31.0 MB | native | 3 |
| 46 | parallel-downloads (async) | 10000 | 33.1 ms | 50.0 ms | **native** | 50.9 MB | 41.2 MB | fxdart | 3 |
| 47 | paged-feeds-dedupe (async) | 10000 | 8.51 ms | 16.3 ms | **native** | 43.2 MB | 26.8 MB | fxdart | 3 |
| 48 | settlement-pipeline (async) | 10000 | 4.46 ms | 3.96 ms | **tie** | 23.2 MB | 24.4 MB | native | 3 |
| 49 | live-search (async) | 10000 | 4.76 ms | 7.98 ms | **native** | 23.1 MB | 24.1 MB | tie | 3 |
| 50 | daily-ledger-close (async) | 10000 | 340.6 ms | 345.2 ms | **tie** | 50.4 MB | 50.5 MB | tie | 5 |
| 51 | category-rank | 10000 | 277 µs | 401 µs | **tie** | 17.5 MB | 21.6 MB | native | 3 |
| 52 | stock-revaluation (async) | 10000 | 32.0 ms | 54.6 ms | **native** | 49.2 MB | 38.3 MB | fxdart | 3 |
...
| 2 | running-balance | 1000000 | 242.8 ms | 287.0 ms | **native** | 182.7 MB | 186.0 MB | tie | 3 |
...
| 16 | compound-interest | 1000000 | 225.7 ms | 251.3 ms | **native** | 125.8 MB | 124.8 MB | tie | 3 |
...
| 28 | no-spend-streak | 1000000 | 24.3 ms | 23.8 ms | **tie** | 106.3 MB | 106.8 MB | tie | 3 |
...
| 37 | restock-plan | 1000000 | 218.8 ms | 203.3 ms | **fxdart** | 173.0 MB | 201.0 MB | native | 3 |
...
| 45 | rate-limited-import (async) | 100000 | 140.9 ms | 285.1 ms | **native** | 76.4 MB | 80.1 MB | tie | 3 |
