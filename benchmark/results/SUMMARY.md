...
- **Date:** 2026-08-10
- **Method:** per side and N-scale, fresh process × rounds, 0 warmup + 1 measured iterations per process (small N auto-batched to ≥2 ms samples); median reported. Ties — within 5.0% of each other, or within 0.6 ms absolute (beneath human perception) — with close relative races re-run up to 5 rounds.
...
| 9 | first-visit-merchants | 100 | 1.6 µs | 3.0 µs | **tie** | 14.2 MB | 14.2 MB | tie | 3 |
...
| 20 | recent-errors | 100 | 1.4 µs | 2.3 µs | **tie** | 14.2 MB | 14.2 MB | tie | 3 |
...
| 42 | anomaly-context | 100 | 1.9 µs | 3.2 µs | **tie** | 14.1 MB | 14.4 MB | tie | 3 |
...
| 9 | first-visit-merchants | 10000 | 154 µs | 301 µs | **tie** | 16.5 MB | 16.5 MB | tie | 3 |
...
| 20 | recent-errors | 10000 | 88 µs | 145 µs | **tie** | 15.8 MB | 15.8 MB | tie | 3 |
...
| 42 | anomaly-context | 10000 | 120 µs | 273 µs | **tie** | 17.0 MB | 17.6 MB | tie | 3 |
...
| 9 | first-visit-merchants | 1000000 | 31.8 ms | 57.4 ms | **native** | 106.6 MB | 110.5 MB | tie | 3 |
...
| 20 | recent-errors | 1000000 | 10.2 ms | 16.6 ms | **native** | 113.9 MB | 113.8 MB | tie | 3 |
...
| 42 | anomaly-context | 1000000 | 11.3 ms | 21.2 ms | **native** | 119.1 MB | 125.2 MB | native | 3 |
