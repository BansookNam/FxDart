...
description: 실전 과제 53개를 순수 Dart와 FxDart로 각각 두 번씩 풀어봅니다. 두 코드는 브라우저에서 바로 실행할 수 있고, 어느 쪽이 더 읽기 좋은지 정직한 판정을 함께 제공합니다.
---
  ...
  <p>
    ...
    충분하다고 말합니다. 바로 그 점이 핵심입니다: 어떤 예제가
    <em>정말로</em> FxDart가 낫다고 말할 때는, 그 말을 믿을 수 있습니다.
  </p>
