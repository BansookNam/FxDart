...
description: FxDart forEach 튜토리얼: 지연 체인의 모든 원소에 대해 부수 효과를 위한 함수를 실행합니다. 동기와 비동기 모두 다룹니다.
...
---
  ...
  <h2>강의</h2>
  <p>
    <code>forEach</code>는 Dart다운 이름이고, fxdart는 FxTS식 표기인
    <code>each</code>도 함께 받습니다 — 같은 연산자입니다.
    <code>toList</code>와 마찬가지로 종결 연산자여서,
  ...
  <p>
    ...
    처리합니다. 겹쳐서 실행하고 싶다면 <code>.forEach()</code> 앞의 상류에
  ...
  <h2>직접 해 보기</h2>
  <p>연습: <code>forEach</code>로 주문마다 영수증 한 줄을 출력하면서
    누적 합계를 계산해 보세요.</p>
  {{playground:2}}
  ...
  <div class="callout">
    ...
    <a href="fx.html"><code>fx</code></a> — forEach가 마무리하는 그 체인
  </div>
