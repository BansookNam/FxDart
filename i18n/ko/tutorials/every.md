...
description: FxDart every 튜토리얼: 모든 원소가 술어를 만족하는지 검사하며 첫 실패에서 단락 평가합니다. 동기와 비동기 모두 다룹니다.
...
---
  ...
  <p>
    ...
    원소를 만나는 즉시 빠져나옵니다 — 단락 평가입니다. 나머지 이터러블은
  ...
  <p>
    ...
    <code>Iterable.every</code>를 상속하고 있고, 그것이 정확히 이런 단락
