...
description: FxDart firstWhereOrNull 튜토리얼: 술어와 일치하는 첫 원소를 지연 평가와 단락 평가로 찾고, 없으면 null을 받는 방법을 익힙니다.
...
---
  ...
  <h2>강의</h2>
  <p>
    <code>firstWhereOrNull</code>은 Dart다운 이름이고, fxdart는 FxTS식
  ...
  <h2>직접 해 보기</h2>
  <p>연습: <code>firstWhereOrNull</code>로 <code>qty &gt; 0</code>인 첫 항목을 찾고, 없으면 <code>null</code>을 받아 보세요.</p>
  {{playground:2}}
