...
description: FxDart expand 튜토리얼: 각 원소를 이터러블로 매핑한 뒤 한 단계 평탄화합니다. 라이브 플레이그라운드 포함.
...
---
  ...
  <p>
    ...
    리스트들을 <code>.expand((list) =&gt; list)</code>로 평탄화하세요 —
    데모 2를 보세요.
  </p>
  ...
  <p>
    ...
    <code>expand</code>는 그 결과를 동기적으로 평탄화하게 하세요:
  </p>
  {{playground:1}}

  <h2>직접 해 보기</h2>
  <p>연습: <code>expand</code>로 각 문장을 단어로 쪼개어
