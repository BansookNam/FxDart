...
---
  ...
  <h2>차이가 나는 이유</h2>
  <p>
    다르지 않습니다. "누가 나타나든 리플레이되는 최신 값"은
    <em>공유된 멀티캐스트 상태</em>이고, fxdart에도
    ...
    업데이트를 받는 피드. 두 패널 모두 "업데이트 넣기, 늦게
    구독하기, 수집하기"입니다 — 손수 캐시한 변수도, 여분의 캐싱
    리스너도 없습니다.
  </p>
  <p>
    이것이 fxdart의 이벤트 레이어가 push 쪽을 위해 Rx의 접근을
