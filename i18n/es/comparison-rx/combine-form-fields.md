...
description: Combinar los últimos valores de email y contraseña para gobernar el botón de envío — Rx.combineLatest2 vs combineLatest en la capa de eventos de fxdart.
...
---
  ...
  <p>
    No difieren. El estado de <em>último-valor-por-fuente</em> es el
