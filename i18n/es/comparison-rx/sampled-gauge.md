...
description: Leer el valor más reciente del medidor en cada tick de sondeo — un stream disparador de sample explícito en RxDart vs sampleOn en la capa de eventos de fxdart.
...
---
  ...
  <p>
    No difieren. «El valor más reciente en este instante» solo existe
    en el modelo push — presupone que las cosas llegan por su cuenta — y
    ambos paneles lo expresan como la misma frase de un solo
  ...
  <p>
    ...
    negativa se mantiene. En su lugar, fxdart absorbe el
    ...
    fxdart lo habla de forma nativa. Y si cada lectura muestreada
