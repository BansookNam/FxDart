...
---
  ...
  <h2>Lección</h2>
  <p>
    <code>distinctBy</code> es la forma general de <code>uniq</code>: en vez de
    comparar los elementos enteros, pasa cada elemento por <code>f</code> y
    conserva solo el primer elemento que produce cada clave distinta.
    <code>distinctBy</code> es el nombre idiomático en Dart; fxdart también
    acepta <code>uniqBy</code>, la grafía de FxTS: son el mismo operador. Es la
  ...
  <h2>Pruébalo tú</h2>
  <p>Ejercicio: usa <code>distinctBy</code> para quedarte solo con el primer evento
