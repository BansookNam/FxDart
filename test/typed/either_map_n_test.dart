...
void main() {
  group('Either.map2', () {
    ...
    test('keeps the first failure', () {
      expect(
        err('a').map2(ok(2), (a, b) => a + b),
        equals(Left<String, int>('a')),
      );
      expect(
        ok(1).map2(err('b'), (a, b) => a + b),
  ...
  group('Either.map3', () {
    test('combines three successes', () {
      expect(
        ok(1).map3(ok(2), ok(3), (a, b, c) => a + b + c),
    ...
    test('keeps the first failure in position order', () {
      expect(
        err('a').map3(err('b'), err('c'), (a, b, c) => a + b + c),
        equals(Left<String, int>('a')),
      );
      expect(
        ok(1).map3(err('b'), err('c'), (a, b, c) => a + b + c),
        equals(Left<String, int>('b')),
      );
      expect(
        ok(1).map3(ok(2), err('c'), (a, b, c) => a + b + c),
  ...
  group('Either.map4', () {
    test('combines four successes', () {
      expect(
        ok(1).map4(ok(2), ok(3), ok(4), (a, b, c, d) => a + b + c + d),
    ...
    test('keeps the first failure in position order', () {
      expect(
        ok(1).map4(ok(2), err('c'), err('d'), (a, b, c, d) => a + b + c + d),
        equals(Left<String, int>('c')),
      );
      expect(
        ok(1).map4(ok(2), ok(3), err('d'), (a, b, c, d) => a + b + c + d),
  ...
  group('Either.map5', () {
    test('combines five successes', () {
      final res = ok(
        1,
      ).map5(ok(2), ok(3), ok(4), ok(5), (a, b, c, d, e) => a + b + c + d + e);
