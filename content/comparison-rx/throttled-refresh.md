...
description: Let one tap through per 300 ms window — throttleTime on the tap stream vs the equivalent throttle chain in fxdart's events layer.
...
---
  ...
  <p>
    They don't. Throttling is rate-limiting <em>arrivals in
